						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<!-- <li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/category">Shop Category</a></li> -->
									<!-- <li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/singleProduct">Product Details</a></li> -->
									<!-- <li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/checkout">Product Checkout</a></li>
									<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/cart">Shopping Cart</a></li>
									<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/confirmation">Confirmation</a></li>
								</ul>
							</li> -->
							<!-- <li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
							...
							<!-- <li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/tracking">Tracking</a></li>
									<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/elements">Elements</a></li>
								</ul>
							</li> -->
							<li class="nav-item"><a class="nav-link" href="<?= BASEURL; ?>/contact">Contact</a></li>
							<li class="nav-item"><a class="nav-link text-primary" href="<?= BASEURL; ?>/login/logout">logout</a></li>
						</ul>
